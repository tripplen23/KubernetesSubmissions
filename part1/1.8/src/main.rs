...
<html lang="en">
  ...
  <body>
    <h1>Todo App</h1>
    <p class="muted">DevOps with Kubernetes &mdash; Exercise 1.8</p>
    <p>This page is served by the <code>todo-app</code> pod running in the
       Kubernetes cluster. The pod was reached from your browser via an
       <code>Ingress</code> (Traefik, path <code>/</code>).</p>
