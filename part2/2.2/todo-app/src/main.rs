...
/// Where the hourly image is cached.
...
async fn index() -> Html<String> {
    let backend_url = env::var("TODO_BACKEND_URL").unwrap_or_else(|_| DEFAULT_TODO_BACKEND_URL.to_string());
...
<html lang="en">
  ...
  <body>
    <h1>Todo App</h1>
    <p class="muted">DevOps with Kubernetes &mdash; Exercise 2.2</p>
    <p>This page is served by the <code>todo-app</code> pod; todos are
       ...
       Service DNS name, like exercise 2.1).</p>
...
/// on the PersistentVolume and serves it (unchanged from 1.12).
